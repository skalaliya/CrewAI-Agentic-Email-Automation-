...
class Settings(BaseModel):
    ...
    litellm_model: str = "ollama/llama3.2:3b"
    ...
    def __init__(self, **kwargs):
        ...
        self.ollama_base_url = os.getenv("OLLAMA_API_BASE", self.ollama_base_url)
        self.litellm_model = os.getenv("LITELLM_MODEL", self.litellm_model)
